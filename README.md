...
A modern, animated inventory management application with real-time stock tracking, dashboard analytics, and beautiful glassmorphism UI.

## ✨ Features

- **Dashboard Analytics** — Real-time stats cards showing inventory health
...
```
warehouse/
├── index.html      # Main HTML structure with stats cards & chart
├── styles.css      # Modern CSS with animations & glassmorphism
